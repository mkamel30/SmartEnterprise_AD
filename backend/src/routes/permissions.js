...
const DEFAULT_PAGE_PERMISSIONS = {
    ...
    '/legacy-import': [ROLES.SUPER_ADMIN, ROLES.MANAGEMENT, ROLES.ACCOUNTANT, ROLES.BRANCH_ADMIN, ROLES.CS_SUPERVISOR, ROLES.BRANCH_MANAGER],
    '/reports': ALL_SYSTEM,
    '/monthly-closing': ALL_SYSTEM,
