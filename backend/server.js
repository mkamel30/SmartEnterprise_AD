...
const warehouseSimsRoutes = require('./src/routes/warehouse-sims');
const warehouseMachinesRoutes = require('./src/routes/warehouse-machines');
const machineWorkflowRoutes = require('./src/routes/machine-workflow');
const maintenanceCenterRoutes = require('./src/routes/maintenance-center');
const maintenanceApprovalsRoutes = require('./src/routes/maintenance-approvals');
const maintenanceShipmentsRoutes = require('./src/routes/maintenance-shipments');
...
app.use('/api/warehouse-sims', warehouseSimsRoutes);
app.use('/api/warehouse-machines', warehouseMachinesRoutes);
app.use('/api/machine-workflow', machineWorkflowRoutes);
app.use('/api/maintenance-center', maintenanceCenterRoutes);
app.use('/api/maintenance-approvals', maintenanceApprovalsRoutes);
app.use('/api/maintenance', maintenanceShipmentsRoutes);
